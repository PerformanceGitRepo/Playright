...
public class steps extends BasePage{
	...
	public void user_launched_swaglabs_application() {
		try {
			page = createPlaywrightPageInstance(System.getProperty("browser","Chromium"));
			page.navigate(System.getProperty("applicationUrl","https://v1.hdfcbank.com/htdocs/common/NetBanking/logout.html"));
